...
export default function Register() {
  ...
  const handleFacebookLogin = () => {
    const clientId = import.meta.env.VITE_FACEBOOK_CLIENT_ID || "123456789";
    const redirectUri = encodeURIComponent(import.meta.env.VITE_FACEBOOK_REDIRECT_URI || "http://localhost:5173/oauth2/callback/facebook");
    const fbUrl = `https://www.facebook.com/v18.0/dialog/oauth?client_id=${clientId}&redirect_uri=${redirectUri}&scope=email,public_profile&response_type=code`;
    window.location.href = fbUrl;
  };

  const handleGoogleLogin = () => {
    const clientId = import.meta.env.VITE_GOOGLE_CLIENT_ID || "mock-google-id";
    const redirectUri = encodeURIComponent(import.meta.env.VITE_GOOGLE_REDIRECT_URI || "http://localhost:5173/oauth2/callback/google");
    const googleUrl = `https://accounts.google.com/o/oauth2/v2/auth?client_id=${clientId}&redirect_uri=${redirectUri}&scope=email%20profile%20openid&response_type=code`;
          ...
          {step === 1 && (
            <div className="space-y-7 animate-fadeIn">
              ...
              <div className="flex items-center gap-3 py-1">
                ...
                <span className="text-gray-400 text-xs font-semibold uppercase tracking-wider">Hoặc đăng nhập nhanh bằng</span>
                <div className="flex-1 h-px bg-gray-200" />
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className="flex items-center justify-center h-12 px-4 rounded-xl border-2 border-gray-200 bg-white hover:border-[#E30019] hover:text-[#E30019] active:scale-[0.98] text-gray-700 text-sm font-bold transition duration-200"
                >
              ...
              <div className="flex items-center gap-3 py-1">
                <div className="flex-1 h-px bg-gray-200" />
                <span className="text-gray-400 text-xs font-semibold uppercase tracking-wider">Hoặc quay lại đăng nhập</span>
                <div className="flex-1 h-px bg-gray-200" />
              </div>
